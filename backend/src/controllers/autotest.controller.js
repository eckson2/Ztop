...
const updateConfig = async (req, res) => {
    try {
        ...
        let { isEnabled, panelType, apiUrl, nameField, templateFields, pfastToken, pfastSecret, m3uLink, appName, customPaymentUrl, dashboardUrl, dashboardUser, dashboardPass } = req.body;
