...
const Subscription = () => {
    ...
    const checkPaymentStatus = async () => {
        ...
        try {
            ...
            if (data.paid) {
                setStatus('success');
                fetchSubscriptionStatus(); // Update subscription info
            }
        } catch (error) {
    ...
    if (status === 'success') {
        return (
            <div className="min-h-screen flex items-center justify-center p-4">
                <div className="max-w-2xl w-full glass p-12 rounded-3xl text-center animate-fade-in">
                    <div className="mb-6 inline-block p-6 bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-full">
                        <CheckCircle size={80} className="text-green-400" />
                    </div>
                    <h1 className="text-4xl font-bold gradient-text mb-4">Pagamento Confirmado!</h1>
                    <p className="text-xl text-slate-300 mb-6">Seu acesso foi renovado com sucesso! 🎉</p>

                    <div className="glass bg-white/5 p-6 rounded-2xl mb-8">
                        <p className="text-sm text-slate-400 mb-2">Sua assinatura agora expira em:</p>
                        <p className="text-2xl font-bold text-white">{formatDate(subscriptionInfo?.expiresAt)}</p>
                    </div>
                    ...
                    <button
                        ...
                        className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-xl font-bold transition-all transform hover:scale-105"
                    >
                ...
                <div className="max-w-3xl w-full">
                    ...
                    <div className="glass p-8 rounded-3xl">
                        ...
                        {paymentData.qrCode ? (
                            ...
                            <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 border-2 border-blue-500/30 p-8 rounded-2xl mb-6 flex flex-col items-center gap-4">
                                <QrCode size={64} className="text-blue-400" />
                                <p className="text-slate-300 text-center">QR Code será exibido aqui</p>
                            </div>
                        )}
